...
<table width="600" align="center" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
  ...
  <tr><td style="padding:32px 40px;">
    <table cellpadding="0" cellspacing="0"><tr>
      ...
      <td>
        <a href="https://wa.me/15553471798" style="display:inline-block;background:transparent;color:#0F6E56;text-decoration:none;padding:12px 24px;border-radius:10px;border:1.5px solid #0F6E56;font-family:monospace;font-size:10px;letter-spacing:1.5px;text-transform:uppercase;">${isEs ? 'Consulta gratis por WhatsApp' : 'Free WhatsApp consultation'}</a>
      </td>
    </tr></table>
  </td></tr>
  ...
  <tr><td style="padding:24px 32px 32px;">
    <table cellpadding="0" cellspacing="0"><tr>
      <td style="padding-right:10px;">
        <a href="https://wa.me/15553471798?text=Hola%20${encodeURIComponent(name)},%20vi%20tu%20perfil%20en%20Biogradix..." style="display:inline-block;background:#18140F;color:#F5F1EB;text-decoration:none;padding:10px 20px;font-family:monospace;font-size:9px;letter-spacing:1.5px;text-transform:uppercase;">Contactar →</a>
      </td>
      <td>
